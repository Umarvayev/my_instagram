    ...
    return (
        ...
        <div className=" items justify-center">
            ...
            <div className="w-72 p-4 flex flex-col justify-between">
                <div className="">
                    ...
                    <div className="border-b relative">
                        ...
                        <textarea
                            ...
                            className="caption-textarea h-20 w-full  text-black"
                ...
                {loading ? (
                    <div className="flex justify-center">
                        <button className="bg-black text-white mt-2 font-bold text-sm rounded text-white w-20 h-8 opacity-70">
                    ...
                    <div className="flex justify-center" onClick={handleSubmit}>
                        <button className="rand_bg_button1">Add Post</button>
                    </div>
                )}
            </div>
        </div>
